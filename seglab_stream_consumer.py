...
if __name__ == "__main__":
    ...
    parser.add_argument("-i", "--object index", dest='indexFile', type="str", required="seglab_config/object_label.csv", help='object index file')
    parser.add_argument("-w", "--object weights", dest='weightFile', type="str", required="seglab_config/object_weight.csv", help='object weight file')
